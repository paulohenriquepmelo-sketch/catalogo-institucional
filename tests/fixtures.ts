...
export const products: Product[] = [
  {
    ...
    brand: 'Linea',
    description:
      'Ergonomia e conforto para rotinas de trabalho intensas, com ajustes intuitivos e acabamento durável.',
    image:
  ...
  },
  {
    ...
    brand: 'Nord',
    description:
      'Luz quente e difusa para compor ambientes acolhedores com desenho minimalista.',
    image:
  ...
  },
  {
    ...
    brand: 'Forma',
    description:
      'Poltrona compacta com linhas envolventes, pensada para salas, recepções e lounges.',
    image:
  ...
  },
  {
    ...
    brand: 'Linea',
    description:
      'Superfície ampla e estrutura leve para reuniões, projetos colaborativos e salas executivas.',
    image:
      'https://images.unsplash.com/photo-1538688423619-a81d3f23454b?auto=format&fit=crop&w=900&q=85',
  ...
  },
  {
    ...
    brand: 'Nord',
    description:
      'Pendente escultural para criar pontos focais em restaurantes, cafés e áreas sociais.',
    image:
  ...
  },
  {
    ...
    brand: 'Forma',
    description:
      'Módulos generosos que se adaptam a lobbies, salas de espera e espaços residenciais.',
    image:
